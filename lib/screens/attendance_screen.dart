...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  // Export CSV Function with platform-specific handling
  Future<void> _exportAttendanceToCSV() async {
    try {
      ...
      _showToast('✅ File CSV berhasil diexport');
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('File CSV berhasil dibuat dengan detail:'),
              const SizedBox(height: 12),
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
              ...
              Text(
                kIsWeb
                    ? 'File akan otomatis terdownload di browser Anda.'
